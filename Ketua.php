...
$pinjam = query("SELECT * FROM data_londry");
  ...
  <div class="container">
    <nav class="navbar navbar-light bg-dark object-fit-cover border rounded mt-3">
      <div class="container-fluid">
        <a class="navbar-brand text-white">Selamat Datang diHalaman Ketua</a>
    ...
    <figure class="text-center mt-4">
      <blockquote class="blockquote">
        <p>Data Customer Laundry</p>
      </blockquote>
      <figcaption class="blockquote-footer">
        <cite title="Source Title">Seira Seira</cite>
      </figcaption>
    </figure>
