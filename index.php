  ...
  <div class="container ">
    <nav class="navbar navbar-light bg-dark object-fit-cover border rounded mt-3">
      <div class="container-fluid">
        <a class="navbar-brand"><img src="image/londry.jpg " width="50" class="rounded float-start" alt=""></a>
    ...
    <div class="container">
      ...
      <figure class="text-center mt-4">
        ...
        <figcaption class="blockquote-footer">
          <cite title="Source Title">Seira Seila</cite>
        </figcaption>
      </figure>
      <h1>Selamat Datang</h1>
      <p> proses mencuci dan merawat pakaian agar tetap bersih dan terawat. Proses ini melibatkan berbagai langkah, mulai dari memisahkan pakaian berdasarkan warna dan jenis kain, mencuci dengan deterjen yang sesuai, hingga proses pengeringan dan pelipatan pakaian.</p>
      <a href="login.php">
